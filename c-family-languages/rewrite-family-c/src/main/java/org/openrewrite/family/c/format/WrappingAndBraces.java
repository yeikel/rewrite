...
public class WrappingAndBraces extends Recipe {
    ...
    private static class WrappingAndBracesCompilationUnitStyle extends CIsoVisitor<ExecutionContext> {
        @Override
        public CSourceFile visitSourceFile(CSourceFile sourceFile, ExecutionContext ctx) {
            WrappingAndBracesStyle style = sourceFile.getStyle(WrappingAndBracesStyle.class);
            if(style == null) {
