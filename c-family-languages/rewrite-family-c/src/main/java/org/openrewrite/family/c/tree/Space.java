...
public class Space {
    ...
    public static Space firstPrefix(@Nullable List<? extends C> trees) {
    ...
    public static <J2 extends C> List<CRightPadded<J2>> formatLastSuffix(@Nullable List<CRightPadded<J2>> trees,
                                                                         Space suffix) {
        if (trees == null) {
            return null;
        }
        ...
        if (!trees.isEmpty() && !trees.get(trees.size() - 1).getAfter().equals(suffix)) {
            List<CRightPadded<J2>> formattedTrees = new ArrayList<>(trees);
            formattedTrees.set(
    ...
    public static <J2 extends C> List<J2> formatFirstPrefix(List<J2> trees, Space prefix) {
