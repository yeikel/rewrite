        ...
        return new JavaIsoVisitor<ExecutionContext>() {
            ...
            private boolean isConvertibleBigDecimalConstant(J elem) {
                if (elem instanceof J.Literal) {
                    return true;
                } else if (elem instanceof J.FieldAccess && ((J.FieldAccess) elem).getTarget().getType() instanceof CType.FullyQualified) {
            ...
            private String getTemplateText(J elem) {
                ...
                if (elem instanceof J.FieldAccess && ((J.FieldAccess) elem).getTarget().getType() instanceof CType.FullyQualified) {
                    J.FieldAccess fa = (J.FieldAccess) elem;
