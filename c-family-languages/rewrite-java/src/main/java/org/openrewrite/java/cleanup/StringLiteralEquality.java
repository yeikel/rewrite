...
public class StringLiteralEquality extends Recipe {
    ...
    private static class StringLiteralEqualityVisitor extends JavaVisitor<ExecutionContext> {
        private static final CType.FullyQualified TYPE_STRING = TypeUtils.asFullyQualified(CType.buildType("java.lang.String"));
        private static final CType TYPE_OBJECT = CType.buildType("java.lang.Object");
        private static final CType.Method.Signature INVOCATION_SIGNATURE = new CType.Method.Signature(CType.Primitive.Boolean, Collections.singletonList(TYPE_OBJECT));
        ...
        private static J.MethodInvocation asEqualsMethodInvocation(J.Binary binary) {
            return new J.MethodInvocation(
                    ...
                    null,
                    J.Identifier.build(Tree.randomId(), Space.EMPTY, Markers.EMPTY, "equals", CType.Primitive.Boolean),
