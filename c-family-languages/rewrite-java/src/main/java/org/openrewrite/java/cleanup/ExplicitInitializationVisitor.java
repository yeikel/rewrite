...
public class ExplicitInitializationVisitor<P> extends JavaIsoVisitor<P> {
    ...
    public J.VariableDeclarations.NamedVariable visitVariable(J.VariableDeclarations.NamedVariable variable, P p) {
        ...
        CType.Primitive primitive = TypeUtils.asPrimitive(variable.getType());
        CType.Array array = TypeUtils.asArray(variable.getType());
        ...
        if (literalInit != null && !variableDecls.hasModifier(J.Modifier.Type.Final)) {
            if (TypeUtils.asFullyQualified(variable.getType()) != null && CType.Primitive.Null.equals(literalInit.getType())) {
            ...
            } else if (array != null && CType.Primitive.Null.equals(literalInit.getType())) {
                v = v.withInitializer(null)
