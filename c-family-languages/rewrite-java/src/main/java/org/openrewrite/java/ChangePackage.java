...
public class ChangePackage extends Recipe {
        ...
        return new JavaIsoVisitor<ExecutionContext>() {
            ...
            public J.CompilationUnit visitCompilationUnit(J.CompilationUnit cu, ExecutionContext executionContext) {
                if (cu.getPackageDeclaration() != null) {
                    String original = J.printTrimmed(cu.getPackageDeclaration().getExpression())
                            .replaceAll("\\s", "");
    ...
    private class ChangePackageVisitor extends JavaIsoVisitor<ExecutionContext> {
        ...
        private final CType.Class newPackageType = CType.Class.build(newPackageName);
        private final CType.Class oldPackageType = CType.Class.build(oldPackageName);
        ...
        public J.ClassDeclaration visitClassDeclaration(J.ClassDeclaration classDecl, ExecutionContext ctx) {
            ...
            if (changingTo != null && classDecl.getType() != null) {
                ...
                CType.FullyQualified type = c.getType();
                if(type != null) {
        ...
        public J.FieldAccess visitFieldAccess(J.FieldAccess fieldAccess, ExecutionContext ctx) {
            ...
            if (f.isFullyQualifiedClassReference(oldPackageName)) {
                if (getCursor().getParent() != null
                    ...
                    f = TypeTree.build(((CType.FullyQualified) newPackageType).getFullyQualifiedName())
        ...
        public J.MethodInvocation visitMethodInvocation(J.MethodInvocation method, ExecutionContext ctx) {
            ...
            if (m.getSelect() != null) {
                CType.FullyQualified selectType = TypeUtils.asFullyQualified(m.getSelect().getType());
        ...
        public J.Package visitPackage(J.Package pkg, ExecutionContext context) {
            String original = J.printTrimmed(pkg.getExpression()).replaceAll("\\s", "");
        ...
        public <N extends NameTree> N visitTypeName(N name, ExecutionContext ctx) {
            ...
            CType.FullyQualified oldType = TypeUtils.asFullyQualified(name.getType());
        ...
        public J.VariableDeclarations.NamedVariable visitVariable(J.VariableDeclarations.NamedVariable variable, ExecutionContext ctx) {
            ...
            CType.FullyQualified varType = TypeUtils.asFullyQualified(variable.getType());
        ...
        private <T extends C> T transformName(@Nullable T nameField) {
            if (nameField instanceof NameTree) {
                CType.FullyQualified nameTree = TypeUtils.asFullyQualified(((NameTree) nameField).getType());
